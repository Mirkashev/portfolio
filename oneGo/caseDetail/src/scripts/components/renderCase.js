export default function renderCase(caseData) {
  ...
  document.querySelector('.case-detail__img').onload = () => {
    document.querySelector('.case-detail__img').classList.remove('hidden');
    document.querySelector('.case-detail-img-loader').classList.add('hidden');
  };
  ...
  document.querySelector('.case-detail__technologies__img').onload = () => {
    document
      .querySelector('.case-detail__technologies__img')
      .classList.remove('hidden');
    document
      .querySelector('.case-detail-technologies-loader')
      .classList.add('hidden');
  };

  document.querySelector('.case-detail__technologies__img-mobile').src =
    caseData.technologiesImgMobile;
  document.querySelector('.case-detail__technologies__img-mobile').onload =
    () => {
      document
        .querySelector('.case-detail__technologies__img-mobile')
        .classList.remove('hidden');
    };
  ...
  document.querySelector('.case-detail__approaches__img').onload = () => {
    document
      .querySelector('.case-detail__approaches__img')
      .classList.remove('hidden');
    document
      .querySelector('.case-detail-approaches-loader')
      .classList.add('hidden');
  };
